...
public class RequestBankDetailsDtoTest extends AbstractValidatorTest<RequestBankDetailsDto> {
    ...
    public static RequestBankDetailsDto createRequestBankDetailsDto(String jurorNumber,
                                                        String accountNo,
                                                        String sortCode,
                                                        String accountName
    ) {
    ...
    void negativeJurorNumberNull() {
        ...
        assertExpectViolations(dto,
            new Violation("jurorNumber", "must not be null")
        );
    }
    ...
    void negativeAccountNumberNull() {
        ...
        assertExpectViolations(dto,
            new Violation("accountNumber", "must not be null")
        );
    }
    ...
    void negativeAccountNumberNullWrongLength() {
        ...
        assertExpectViolations(dto,
            new Violation("accountNumber", "must match \"^\\d{8}$\"")
        );
    }
    ...
    void negativeAccountNameNull() {
        ...
        assertExpectViolations(dto,
            new Violation("accountHolderName", "must not be empty")
        );
    }
    ...
    void negativeAccountNameWrongLength() {
        RequestBankDetailsDto dto = createRequestBankDetailsDto("123456789", "12345678",
            "112233",
            "Mr Fname Lname Too Long");

        assertExpectViolations(dto,
            new Violation("accountHolderName", "length must be between 0 and 18")
        );
    }
    ...
    void negativeSortCodeNull() {
        ...
        assertExpectViolations(dto,
            new Violation("sortCode", "must not be null")
        );
    }
    ...
    void negativeSortCodeWrongLength() {
        ...
        assertExpectViolations(dto,
            new Violation("sortCode", "must match \"^\\d{6}$\"")
        );
    }

...
values
    ...
    --3 Draft
    ('2023-01-05', '641500020', '415', '09:30', '16:00', false, 10, 0, 0.66, '2023-01-19', true, '415230101',
     false, 10, 0, 20, 0, 30, 0, 40, 0, 50, 0, 60, 0, 70, 0, 80, 0, 90, 0, 100, 0, 25, 0, 'FULL_DAY', true,
     null, 'EXPENSE_ENTERED'),
    ('2023-01-06', '641500020', '415', '09:30', '16:00', false, 10, 0, 0.66, '2023-01-19', true, '415230101',
     true, 11, 0, 21, 0, 31, 0, 41, 0, 51, 0, 61, 0, 71, 0, 81, 0, 91, 0, 101, 0, 26, 0, 'FULL_DAY', true,
     null, 'EXPENSE_ENTERED'),
    ('2023-01-07', '641500020', '415', '09:30', '16:00', false, 10, 0, 0.66, '2023-01-19', true, '415230101',
     false, 12, 0, 22, 0, 32, 0, 42, 0, 52, 0, 62, 0, 72, 0, 82, 0, 92, 0, 102, 0, 27, 0, 'HALF_DAY', true,
     null, 'EXPENSE_ENTERED'),
    --3 For Approval
    ('2023-01-08', '641500020', '415', '09:30', '16:00', false, 10, 0, 0.66, '2023-01-19', true, '415230101',
     false, 13.97, 0, 23, 0, 33, 0, 43, 0, 53, 0, 63, 0, 73, 0, 83, 0, 93, 0, 103, 0, 28, 0, 'FULL_DAY', false,
     '123', 'EXPENSE_ENTERED'),
    ('2023-01-09', '641500020', '415', '09:30', '16:00', false, 10, 0, 0.66, '2023-01-19', true, '415230101',
     false, 14.01, 0, 24, 0, 34, 0, 44, 0, 54, 0, 64, 0, 74, 0, 84, 0, 94, 0, 104, 0, 29, 0, 'FULL_DAY', false,
     '123', 'EXPENSE_ENTERED'),
    ('2023-01-10', '641500020', '415', '09:30', '16:00', false, 10, 0, 0.66, '2023-01-19', true, '415230101',
     false, 15, 0, 25, 0, 35, 0, 45, 0, 55, 0, 65, 0, 75, 0, 85, 0, 95, 0, 105, 0, 30, 0, 'FULL_DAY', false,
     '123', 'EXPENSE_ENTERED'),
    -- 3 Approved
    ('2023-01-11', '641500020', '415', '09:30', '16:00', false, 0, 10, 0.66, '2023-01-19', true, '415230101',
     false, 0, 103, 0, 93, 0, 83, 0, 73, 0, 63, 0, 53, 0, 43, 0, 33, 0, 23, 0, 13, 0, 28, 'FULL_DAY', false,
     '321', 'EXPENSE_AUTHORISED'),
    ('2023-01-12', '641500020', '415', '09:30', '16:00', false, 0, 10, 0.66, '2023-01-19', true, '415230101',
     false, 0, 104, 0, 94, 0, 84, 0, 74, 0, 64, 0, 54, 0, 44, 0, 34, 0, 24, 0, 14, 0, 29, 'FULL_DAY', false,
     '321', 'EXPENSE_AUTHORISED'),
    ('2023-01-13', '641500020', '415', '09:30', '16:00', false, 0, 10, 0.66, '2023-01-19', true, '415230101',
     false, 0, 105, 0, 95, 0, 85, 0, 75, 0, 65, 0, 55, 0, 45, 0, 35, 0, 25, 0, 15, 0, 30, 'FULL_DAY', false,
     '321', 'EXPENSE_AUTHORISED'),
    -- 2 Approved - 1 edited
    ('2023-01-14', '641500020', '415', '09:30', '16:00', false, 0, 10, 0.66, '2023-01-19', true, '415230101',
     false, 0, 103, 0, 93, 0, 83, 0, 73, 0, 63, 0, 53, 0, 43, 0, 33, 0, 23, 0, 13, 0, 28, 'FULL_DAY', false,
     '12345', 'EXPENSE_AUTHORISED'),
    ('2023-01-15', '641500020', '415', '09:30', '16:00', false, 0, 10, 0.66, '2023-01-19', true, '415230101',
     false, 30, 104, 4, 94, 11, 84, 0, 74, 19.45, 64, 13, 54, 0.44, 44, 2.03, 34, 0.01, 24, 3.93, 14, 0, 29,
     'FULL_DAY', false,
     '12345', 'EXPENSE_EDITED'),
    ('2023-01-16', '641500020', '415', '09:30', '16:00', false, 0, 10, 0.66, '2023-01-19', true, '415230101',
     false, 0, 105, 0, 95, 0, 85, 0, 75, 0, 65, 0, 55, 0, 45, 0, 35, 0, 25, 0, 15, 0, 30, 'FULL_DAY', false,
     '12345', 'EXPENSE_AUTHORISED'),

-- negative
    ('2023-01-16', '641500022', '415', '09:30', '16:00', false, 0, 10, 0.66, '2023-01-19', true, '415230101',
     false, 0, 105, 0, 95, 0, 85, 0, 75, 0, 65, 0, 55, 0, 45, 0, 35, 0, 25, 0, 15, 0, 30, 'FULL_DAY', true,
     '12345', 'APPEARANCE_CONFIRMED')
;
...
(revision, rev_type,
 ...
 subsistence_due, subsistence_paid, smart_card_due, smart_card_paid, attendance_type, is_draft_expense, f_audit,
 appearance_stage)
values (1, 1, '2023-01-15', '641500020', '415', '09:30', '16:00', false, 0, 10, 0.66, '2023-01-19', true,

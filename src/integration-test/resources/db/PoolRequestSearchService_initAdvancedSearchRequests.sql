...
INSERT INTO JUROR_MOD.POOL
(OWNER, POOL_NO, RETURN_DATE, TOTAL_NO_REQUIRED, NO_REQUESTED, POOL_TYPE, LOC_CODE, NEW_REQUEST)
VALUES('400', '416230101', TIMESTAMP '2023-01-09 00:00:00.000000', 100, 100, 'CIV', '416', 'N');
...
VALUES('416', '416230102', date_trunc('day', current_date), 0, 0, 'CRO', '416', 'N', true);

-- 416230103 - COMPLETED - Crown Court
INSERT INTO JUROR_MOD.POOL
(OWNER, POOL_NO, RETURN_DATE, TOTAL_NO_REQUIRED, NO_REQUESTED, POOL_TYPE, LOC_CODE, NEW_REQUEST)
VALUES('416', '416230103', '2023-01-23', 100, 100, 'CRO', '416', 'N');

-- 416230104 - COMPLETED (NIL POOL) - Crown Court
INSERT INTO JUROR_MOD.POOL
(OWNER, POOL_NO, RETURN_DATE, TOTAL_NO_REQUIRED, NO_REQUESTED, POOL_TYPE, LOC_CODE, NEW_REQUEST, nil_pool)
VALUES('416', '416230104', TIMESTAMP '2023-01-30 00:00:00.000000', 0, 0, 'CRO', '416', 'N', true);

-- 416230105 - REQUESTED - High Court
INSERT INTO JUROR_MOD.POOL
(OWNER, POOL_NO, RETURN_DATE, TOTAL_NO_REQUIRED, NO_REQUESTED, POOL_TYPE, LOC_CODE, NEW_REQUEST)
VALUES('416', '416230105', TIMESTAMP '2023-01-16 00:00:00.000000', 100, 100, 'HGH', '416', 'Y');
...
INSERT INTO JUROR_MOD.POOL
(OWNER, POOL_NO, RETURN_DATE, TOTAL_NO_REQUIRED, NO_REQUESTED, POOL_TYPE, LOC_CODE, NEW_REQUEST)
VALUES('417', '417230101', TIMESTAMP '2023-01-09 00:00:00.000000', 100, 100, 'CRO', '417', 'N');

-- 417230102 - ACTIVE - Civil Court
INSERT INTO JUROR_MOD.POOL
(OWNER, POOL_NO, RETURN_DATE, TOTAL_NO_REQUIRED, NO_REQUESTED, POOL_TYPE, LOC_CODE, NEW_REQUEST)
VALUES('400', '417230102', TIMESTAMP '2023-01-16 00:00:00.000000', 100, 100, 'CIV', '417', 'N');

-- 417230103 - NIL POOL - Crown Court
INSERT INTO JUROR_MOD.POOL
(OWNER, POOL_NO, RETURN_DATE, TOTAL_NO_REQUIRED, NO_REQUESTED, POOL_TYPE, LOC_CODE, NEW_REQUEST, nil_pool)
VALUES('400', '417230103', '2023-01-23', 0, 0, 'CRO', '417', 'N', true);

-- 417230104 - REQUESTED - Civil Court
INSERT INTO JUROR_MOD.POOL
(OWNER, POOL_NO, RETURN_DATE, TOTAL_NO_REQUIRED, NO_REQUESTED, POOL_TYPE, LOC_CODE, NEW_REQUEST)
VALUES('417', '417230104', TIMESTAMP '2023-01-30 00:00:00.000000', 100, 100, 'CIV', '417', 'Y');

...
VALUES ('200000001', 'John1', 'Smith1', 'AD1 2HP', 'House', true),
       ...
       ('200000007', 'John7', 'Smith7', 'AD7 2HP', 'House', true),
       ('200000008', 'John8', 'Smith8', 'AD8 2HP', 'House', true),
       ('200000009', 'John9', 'Smith9', 'AD9 2HP', 'House', true);
...
VALUES
    -- T000000001: three current jurors (result J, empanelled, no return date)
    ('415', '200000001', 'T000000001', 10, '2024-05-08 00:00:00', 'J',  true,  '2024-05-08', NULL),
    ...
    -- T000000001: not used — excluded by currentJurorsOnly
    ('415', '200000007', 'T000000001', 10, '2024-05-08 00:00:00', 'NU', false, NULL,         NULL),
    -- T000000001: challenged — excluded by currentJurorsOnly
    ('415', '200000008', 'T000000001', 10, '2024-05-08 00:00:00', 'CD', false, NULL,         NULL),
    -- T000000001: was a juror but discharged mid-trial — excluded by currentJurorsOnly
    ('415', '200000009', 'T000000001', 10, '2024-05-08 00:00:00', 'J',  true,  '2024-05-08', '2024-05-10'),
    -- T000000002: anonymous trial jurors

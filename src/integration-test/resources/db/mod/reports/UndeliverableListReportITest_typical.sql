...
insert into juror_mod.juror (juror_number, last_name, first_name, dob, no_def_pos, m_phone, w_phone, h_phone,
                            h_email, police_check, address_line_1, responded)
values ('641500020', 'Smith0', 'John0', '1980-01-01', 0, '000000001', '000000002', '000000003',
        '641500020@email.gov.uk', 'ELIGIBLE', 'addressLine1', false),
       ('641500021', 'Smith1', 'John1', '1980-01-01', 0, '100000001', '100000002', '100000003',
        '641500021@email.gov.uk', 'ELIGIBLE', 'addressLine1', false),
       ...
       ('641500024', 'Smith4', 'John4', '1980-01-01', 0, '400000001', '400000002', '400000003',
        '641500024@email.gov.uk', null, 'addressLine1', false),
       ...
       ('641500026', 'Smith6', 'John6', '1980-01-01', 0, '600000001', '600000002', '600000003',
        '641500026@email.gov.uk', 'NOT_CHECKED', 'addressLine1', false)
;

-- create juror_pool associative records
insert into juror_mod.juror_pool (owner, juror_number, pool_number, status, is_active)
values ('400', '641500020', '415230101', 9, true),
       ('400', '641500021', '415230101', 9, true),

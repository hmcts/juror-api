...
INSERT INTO juror_mod.users (created_by, updated_by,username,email, name, active,last_logged_in,team_id, user_type)
VALUES ('testlogin','testlogin','testlogin','testlogin@email.gov.uk','Test Login',true,CURRENT_DATE - 3,1, 'BUREAU');

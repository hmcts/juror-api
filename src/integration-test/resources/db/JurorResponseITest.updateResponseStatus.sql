...
INSERT INTO juror_mod.users (owner, username,email, name, active,last_logged_in,team_id,version, user_type)
VALUES ('400','testlogin','testlogin@email.gov.uk','Test Login',true,CURRENT_DATE - 3,1,0, 'BUREAU');

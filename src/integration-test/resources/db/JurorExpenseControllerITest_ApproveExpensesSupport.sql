INSERT INTO juror_mod.financial_audit_details(id, juror_revision,
                                              ...
                                              loc_code)
VALUES (12345, 1, 1, 'FOR_APPROVAL_EDIT', 'COURT_USER2', '2025-01-11 09:31:01.000',
        '641500020', '415'),
       (12344, 1, 1, 'APPROVED_BACS', 'COURT_USER3', '2025-01-10 09:31:01.000',
        '641500020', '415');
INSERT INTO juror_mod.financial_audit_details_appearances (financial_audit_id, loc_code,
                                                           attendance_date, appearance_version)
VALUES (12344, '415', '2025-01-14', 1),
       (12344, '415', '2025-01-15', 1),
       (12344, '415', '2025-01-16', 1),
       (12345, '415', '2025-01-14', 2),
       (12345, '415', '2025-01-15', 2),
       (12345, '415', '2025-01-16', 2);
...
VALUES (0, 1, 1, '2025-01-14', '641500020', '415', '09:30', '16:00', false, '00:40', true, '415230101', false, 0, 103,
        0, 93, 0, 83, 0, 73, 0, 63, 0, 53, 0, 43, 0, 33, 0, 23, 0, 13, 0, 28, 'FULL_DAY', false, '12344',
        'EXPENSE_AUTHORISED'),
       (0, 1, 1, '2025-01-15', '641500020', '415', '09:30', '16:00', false, '00:40', true, '415230101', false, 0, 104,
        0, 94, 0, 84, 0, 74, 0, 64, 0, 54, 0, 44, 0, 34, 0, 24, 0, 14, 0, 29, 'FULL_DAY', false, '12344',
        'EXPENSE_AUTHORISED'),
       (0, 1, 1, '2025-01-16', '641500020', '415', '09:30', '16:00', false, '00:40', true, '415230101', false, 0, 105,

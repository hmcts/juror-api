...
INSERT INTO juror_mod.users (username, email, name, active, team_id, version, approval_limit)
VALUES ('COURT_USER', 'COURT_USER@email.gov.uk', 'Stephanie Mcintyre', true, 1, 1, 10000),
       ('COURT_USER2', 'COURT_USER2@email.gov.uk', 'Stephanie Mcintyre', true, 1, 1, 500),
       ('COURT_USER3', 'COURT_USER3@email.gov.uk', 'Stephanie Mcintyre', true, 1, 1, 100);

...
INSERT INTO juror_mod.juror (juror_number,poll_number,last_name,first_name,dob,address_line_1,address_line_2,postcode,responded,user_edtq,no_def_pos,notifications,notes) VALUES
	 ('987654322','543','LNAME','FNAME','1988-03-31 00:00:00','543 STREET NAME','ANYTOWN','CH1 2AN','Y','BUREAU_USER',1,0,''),
...
INSERT INTO juror_mod.juror_pool ("owner",juror_number,pool_number,user_edtq,status,is_active,pool_seq,"location",on_call) VALUES
	 ...
	 ('400','987654322','415220502','BUREAU_USER',2,'Y','0109','415','N');
...
VALUES
    ...
    ('00000000-0000-0000-0000-000000106003', 'DBD_DEF_DENIED_ENG', 'DBD DEFERRAL DENIED ENGLISH TEST', NULL, 1, 0),
    ('00000000-0000-0000-0000-000000106004', 'DBD_DEF_DENIED_CY', 'DBD DEFERRAL DENIED WELSH TEST', NULL, 1, 0)

            ...
            .assertEquals(JurySummoningMonitorReportResponse.builder()
                .headings(Map.of("courts", AbstractReportResponse.DataTypeValue.builder()
                    ...
                    "report_created", AbstractReportResponse.DataTypeValue.builder()
                        ...
                        .value(LocalDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE))
                        .build()))
                .totalJurorsNeeded(28)
                .bureauDeferralsIncluded(1)
                .bureauToSupply(27)
                .initiallySummoned(19)
                .ratio(0.7)
                .additionalSummonsIssued(10)
                .reminderLettersIssued(2)
                .totalConfirmedJurors(5)
                .deferralsRefused(1)
                .excusalsRefused(1)
                .totalUnavailable(24)
                .nonResponded(14)
            ...
            .assertEquals(JurySummoningMonitorReportResponse.builder()
                .headings(Map.of("courts", AbstractReportResponse.DataTypeValue.builder()
                    ...
                    "report_created", AbstractReportResponse.DataTypeValue.builder()
                        ...
                        .value(LocalDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE))
                        .build()))
                .totalJurorsNeeded(27)
                .bureauDeferralsIncluded(1)
                .bureauToSupply(26)
                .initiallySummoned(26)
                .ratio(1.0)
                .additionalSummonsIssued(10)
                .reminderLettersIssued(3)
                .totalConfirmedJurors(7)
                .deferralsRefused(2)
                .excusalsRefused(2)
                .totalUnavailable(25)
                .nonResponded(16)

...
public class ResponseExcusalControllerTest extends AbstractIntegrationTest {
    ...
    public void excuseJuror_happy() throws Exception {
        ...
        softly.assertThat(jdbcTemplate.queryForObject("SELECT PROCESSING_COMPLETE FROM JUROR_DIGITAL.JUROR_RESPONSE " +
            ...
            .isEqualToIgnoringCase("Y");
        softly.assertThat(jdbcTemplate.queryForObject("SELECT COMPLETED_AT FROM JUROR_DIGITAL.JUROR_RESPONSE WHERE " +
        ...
        softly.assertThat(jdbcTemplate.queryForObject("SELECT COUNT(*) FROM JUROR_DIGITAL_USER.PART_HIST WHERE " +
                "PART_NO='644892530' AND HISTORY_CODE='PEXC'", Integer.class))
        ...
        softly.assertThat(jdbcTemplate.queryForObject("SELECT OWNER FROM JUROR_DIGITAL_USER.PART_HIST WHERE " +
                "PART_NO='644892530' AND HISTORY_CODE='PEXC'", String.class))
            .as("Juror's PART_HIST entry should have 400 set as the owner")
            .isEqualTo("400");
        ...
        softly.assertThat(jdbcTemplate.queryForObject("SELECT OTHER_INFORMATION FROM JUROR_DIGITAL_USER.PART_HIST " +
                "WHERE PART_NO='644892530' AND HISTORY_CODE='PEXC'", String.class))
    ...
    public void excuseJuror_unhappy_JurorNotFound() throws Exception {
        ...
        softly.assertThat(jdbcTemplate.queryForObject("SELECT COUNT(*) FROM JUROR_DIGITAL.JUROR_RESPONSE WHERE " +
            ...
            .isEqualTo(0);
        softly.assertThat(jdbcTemplate.queryForObject("SELECT COUNT(*) FROM JUROR.POOL WHERE PART_NO='123456789'",
                Integer.class))
            .as("Juror should not have a Pool entry")
            .isEqualTo(0);
        softly.assertThat(jdbcTemplate.queryForObject("SELECT COUNT(*) FROM JUROR_DIGITAL_USER.PART_HIST WHERE " +
                "PART_NO='123456789'", Integer.class))
            .as("Juror should not have a PART_HIST entry")
            .isEqualTo(0);
    ...
    public void rejectExcusalRequest_happy() throws Exception {
        ...
        softly.assertThat(jdbcTemplate.queryForObject("SELECT USER_EDTQ FROM JUROR.POOL WHERE PART_NO='644892530'",
            ...
            .as("Juror's pool entry should have USER_EDTQ set to user login")
            .isEqualTo(LOGIN_NAME);
        softly.assertThat(jdbcTemplate.queryForObject("SELECT ACC_EXC FROM JUROR.POOL WHERE PART_NO='644892530'",
                String.class))
        ...
        softly.assertThat(jdbcTemplate.queryForObject("SELECT COUNT(*) FROM JUROR_DIGITAL_USER.PART_HIST WHERE " +
            ...
            .isEqualTo(1);
        softly.assertThat(jdbcTemplate.queryForObject("SELECT COUNT(*) FROM JUROR_DIGITAL_USER.PART_HIST WHERE " +
                "PART_NO='644892530' AND HISTORY_CODE='RESP'", Integer.class))
        ...
        softly.assertThat(jdbcTemplate.queryForObject("SELECT OTHER_INFORMATION FROM JUROR_DIGITAL_USER.PART_HIST " +
                "WHERE PART_NO='644892530' AND HISTORY_CODE='RESP'", String.class))

...
class PoolAnalysisReportITest extends AbstractStandardReportControllerITest {
    ...
    @Autowired
    PoolAnalysisReportITest(TestRestTemplate template) {
        ...
        return new StandardTableData(
            List.of(
                new ReportLinkedMap<String, Object>()
                    ...
                    .add("responded_total_percentage", 27.777_78)
                    .add("attended_total_percentage", 11.111_11)
                    .add("panel_total_percentage", 0.0)
                    .add("juror_total_percentage", 0.0)
                    .add("excused_total_percentage", 5.555_56)
                    .add("disqualified_total_percentage", 5.555_56)
                    .add("deferred_total_percentage", 16.666_67)
                    .add("reassigned_total_percentage", 5.555_56)
                    .add("undeliverable_total_percentage", 11.111_11)
                    .add("transferred_total_percentage", 22.222_22)
                    .add("failed_to_attend_total_percentage", 5.555_56),
                getCourtSatelliteTableData()
            )
        );
    }

...
/**
 * QBureauJurorDetail is a Querydsl query type for BureauJurorDetail
 */
@Generated("com.querydsl.codegen.EntitySerializer")
public class QBureauJurorDetail extends EntityPathBase<BureauJurorDetail> {

    private static final long serialVersionUID = 727611326L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QBureauJurorDetail bureauJurorDetail = new QBureauJurorDetail("bureauJurorDetail");

    public final StringPath altPhoneNumber = createString("altPhoneNumber");

    public final QStaff assignedStaffMember;

    public final StringPath bail = createString("bail");

    public final StringPath bailDetails = createString("bailDetails");

    public final SetPath<ChangeLog, QChangeLog> changeLogs = this.<ChangeLog, QChangeLog>createSet("changeLogs", ChangeLog.class, QChangeLog.class, PathInits.DIRECT2);

    public final ListPath<BureauJurorCJS, QBureauJurorCJS> cjsEmployments = this.<BureauJurorCJS, QBureauJurorCJS>createList("cjsEmployments", BureauJurorCJS.class, QBureauJurorCJS.class, PathInits.DIRECT2);
    ...
    public final ListPath<PhoneLog, QPhoneLog> phoneLogs = this.<PhoneLog, QPhoneLog>createList("phoneLogs", PhoneLog.class, QPhoneLog.class, PathInits.DIRECT2);
    ...
    public final ListPath<BureauJurorSpecialNeed, QBureauJurorSpecialNeed> specialNeeds = this.<BureauJurorSpecialNeed, QBureauJurorSpecialNeed>createList("specialNeeds", BureauJurorSpecialNeed.class, QBureauJurorSpecialNeed.class, PathInits.DIRECT2);
    ...
    public QBureauJurorDetail(String variable) {
        this(BureauJurorDetail.class, forVariable(variable), INITS);
    }

    public QBureauJurorDetail(Path<? extends BureauJurorDetail> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QBureauJurorDetail(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QBureauJurorDetail(PathMetadata metadata, PathInits inits) {
        this(BureauJurorDetail.class, metadata, inits);
    }

    public QBureauJurorDetail(Class<? extends BureauJurorDetail> type, PathMetadata metadata, PathInits inits) {
        super(type, metadata, inits);
        this.assignedStaffMember = inits.isInitialized("assignedStaffMember") ? new QStaff(forProperty("assignedStaffMember"), inits.get("assignedStaffMember")) : null;
    }

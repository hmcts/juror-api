...
VALUES
    ...
    ('1827315e-9557-4985-ba53-395cb18f76dd', 'DBD_EXC_DENIED_ENG', 'DBD_Deferral denied (English)', 5226, 1, 0),
    ...
    ('1ee63277-e3e7-43b9-a5c8-725bacda8287', 'DBD_REQUEST_INFO_ENG', 'DBD_Request info (English)', 5227C, 1, 0),
    ('525613fc-144e-4403-abcb-9257ad41b178', 'DBD_REQUEST_INFO_CY', 'DBD_Request info (Welsh)', 5227, 1, 0),
    ('82b30231-1980-454a-b812-0e7953f7cccf', 'DBD_WITHDRAWAL_ENG', 'DBD_Disqualified (English)', 5224, 1),
    ('55ed91ab-76c6-4ff7-908a-f2fe3c9d5824', 'DBD_WITHDRAWAL_CY', 'DBD_Disqualified (Welsh)', 5224C, 1);
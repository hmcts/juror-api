...
alter table juror_mod.juror
    ALTER COLUMN h_phone TYPE varchar(20),
    ALTER COLUMN m_phone TYPE varchar(20),
    ALTER COLUMN w_phone TYPE varchar(20);
...
alter table juror_mod.juror_audit
  ...
  alter table juror_mod.juror_response
      ...
      ALTER COLUMN alt_phone_number TYPE varchar(20);

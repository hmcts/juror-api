...
AS
SELECT llfad2.public_transport_total_approved,
       ...
       llfad2.public_transport_total_approved + llfad2.hired_vehicle_total_approved + llfad2.motorcycle_total_approved +
       llfad2.car_total_approved + llfad2.pedal_cycle_total_approved + llfad2.parking_total_approved +
       llfad2.loss_of_earnings_approved + llfad2.childcare_total_approved + llfad2.misc_total_approved +
       llfad2.subsistence_approved + llfad2.smart_card_approved                                        AS total_approved,
       llfad2.public_transport_total_approved + llfad2.hired_vehicle_total_approved + llfad2.motorcycle_total_approved +
       llfad2.car_total_approved + llfad2.pedal_cycle_total_approved +
       llfad2.parking_total_approved                                                                   AS total_travel_approved,
       llfad2.loss_of_earnings_approved + llfad2.childcare_total_approved +
       llfad2.misc_total_approved                                                                      AS total_financial_loss_approved,
...
FROM (SELECT llfad.public_transport_total_paid -
             ...
             CASE
                 WHEN llfad.type::text = ANY
                      (ARRAY ['REAPPROVED_CASH'::character varying, 'REAPPROVED_BACS'::character varying]::text[])
      ...
      FROM juror_mod.low_level_financial_audit_details llfad
               LEFT JOIN juror_mod.low_level_financial_audit_details lastapprovedllfad
                         ON lastapprovedllfad.id = llfad.last_approved_faudit AND
                            lastapprovedllfad.loc_code::text = llfad.loc_code::text AND
                            lastapprovedllfad.attendance_date = llfad.attendance_date AND (llfad.type::text = ANY
                                                                                           (ARRAY ['REAPPROVED_BACS'::character varying, 'REAPPROVED_CASH'::character varying]::text[]))) llfad2;
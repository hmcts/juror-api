CREATE OR REPLACE PROCEDURE juror_mod.housekeeping_content_store_deletion(p_max_threshold INTEGER, p_start_time_int INTEGER, p_max_timeout INTEGER, INOUT p_print_msg text)
LANGUAGE plpgsql
as
/***********************************************************************************************************************
...
BEGIN
	...
	WHERE cs.date_on_q_for_send < CURRENT_DATE - p_max_threshold;

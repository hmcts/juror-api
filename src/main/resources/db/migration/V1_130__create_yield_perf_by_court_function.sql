...
-- Function to return yield performance report stats
...
select ut.loc_code as loc_code, sum(ut.no_requested)::integer as no_requested, sum(ut.supplied)::integer as supplied from union_tables ut
group by ut.loc_code;

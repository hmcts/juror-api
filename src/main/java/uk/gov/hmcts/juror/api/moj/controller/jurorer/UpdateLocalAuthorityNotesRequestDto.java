...
public class UpdateLocalAuthorityNotesRequestDto {
    ...
    @Schema(description = "Notes for the local authority (null to clear notes)", example = "Contact attempted on 15/02/2025", requiredMode = Schema.RequiredMode.NOT_REQUIRED)

...
@Slf4j
public class JurorErPreAuthenticationTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        Authentication authentication = authenticationManager.authenticate(new JurorErJwtAuthentication(jwt));

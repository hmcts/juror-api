...
public class SummonsReminderLetter extends LetterBase {
    public SummonsReminderLetter(JurorPool jurorPool,
    ...
    protected void setupEnglish() {
        setFormCode(FormCode.ENG_SUMMONS_REMINDER);
    ...
    private void sharedSetup() {
        ...
        addData(LetterDataType.JUROR_LAST_NAME, 20); // keep old length and position
        addJurorAddress();

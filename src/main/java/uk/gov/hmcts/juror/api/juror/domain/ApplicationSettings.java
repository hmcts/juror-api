...
public class ApplicationSettings implements Serializable {
    ...
    public enum Setting {
        ...
        EMAIL_ATTACHMENT_DOC_ALLOWANCES_EN,
        EMAIL_ATTACHMENT_DOC_ALLOWANCES_CY,
        EMAIL_ATTACHMENT_DOC_LOSS_OF_EARNINGS_EN,
        EMAIL_ATTACHMENT_DOC_LOSS_OF_EARNINGS_CY,
        EMAIL_ATTACHMENT_DOC_GUIDANCE_EMPLOYERS_EN,
        EMAIL_ATTACHMENT_DOC_GUIDANCE_EMPLOYERS_CY,
        EMAIL_ATTACHMENT_DOC_JURY_GUIDE_EN,
        EMAIL_ATTACHMENT_DOC_JURY_GUIDE_CY
    }
}

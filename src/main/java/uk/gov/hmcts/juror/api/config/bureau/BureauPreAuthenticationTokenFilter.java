...
@Slf4j
public class BureauPreAuthenticationTokenFilter extends OncePerRequestFilter {
    private final String headerName;
    private final AuthenticationManager authenticationManager;

    public BureauPreAuthenticationTokenFilter(final String headerName,
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        Authentication authentication = authenticationManager.authenticate(new BureauJwtAuthentication(jwt));

...
public class LetterListResponseDto {
    ...
    @JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = WithdrawalLetterData.class, name = "Withdrawal Letter Data"),
        ...
        @JsonSubTypes.Type(value = FailedToAttendLetterData.class, name = "Failed To Attend Letter Data"),
    })

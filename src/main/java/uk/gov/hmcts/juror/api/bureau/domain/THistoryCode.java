...
public class THistoryCode {
    ...
    public static final String EXCUSE_POOL_MEMBER = "PEXC";
    public static final String DISQUALIFY_POOL_MEMBER = "PDIS";
    public static final String DISQUALIFY_RESPONSE = "RDIS";

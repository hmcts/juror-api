...
public enum HistoryCodeMod {
    ...
    RESEND_DEFERRED_LETTER("RLDL", "Resend Deferred Letter"),
    RESEND_NON_DEFERRED_LETTER("RLND", "Resend Non-Deferred Letter"),
    RESEND_WITHDRAWAL_LETTER("RLWL", "Resend Withdrawal Letter"),
    RESEND_NON_EXCUSED_LETTER("RLNE", "Resend Non-Excused Letter"),
    RESEND_EXCUSAL_LETTER("RLEL", "Resend Excusal Letter"),
    RESEND_POSTPONED_LETTER("RLPT", "Resend Postponed Letter"),
    RESEND_NON_RESPONDED_LETTER("RLNR", "Resend Non Responded Letter"),
    RESEND_RESPONDED_LETTER("RLRL", "Resend Responded Letter"),
    RESEND_RESPONSE_PACK("RLPK", "Resend Response Pack"),

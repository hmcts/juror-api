...
public class AvailableListByDateReportCourt extends AbstractGroupedReport implements AvailableListReport {
    ...
    public AvailableListByDateReportCourt(PoolRequestRepository poolRequestRepository,
    ...
    @Override
    public Class<AvailableListByDateReportCourt.RequestValidator> getRequestValidatorClass() {
        return AvailableListByDateReportCourt.RequestValidator.class;
    }

    public interface RequestValidator extends
        AvailableListReport.RequestValidator,
        AbstractReport.Validators.RequireDate {
    }
}

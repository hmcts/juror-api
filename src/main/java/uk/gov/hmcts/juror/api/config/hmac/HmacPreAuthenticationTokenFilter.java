...
@Slf4j
public class HmacPreAuthenticationTokenFilter extends OncePerRequestFilter {
    private final String headerName;
    private final AuthenticationManager authenticationManager;

    public HmacPreAuthenticationTokenFilter(final String headerName,
                                            final AuthenticationManager authenticationManager) {
        this.headerName = headerName;
        this.authenticationManager = authenticationManager;
        Assert.notNull(headerName, "The token header name was not set");
        Assert.notNull(authenticationManager, "AuthenticationManager was not set");
    }
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        Authentication authentication = authenticationManager.authenticate(new HmacJwtAuthentication(jwt));

...
public class DbdResponseLetter extends LetterBase {
    public DbdResponseLetter(JurorPool jurorPool,
    ...
    protected void setupWelsh() {
        setFormCode(FormCode.BI_DBD_RESPONSE);
        sharedJurorSetupDbd();
    ...
    protected void setupEnglish() {
        setFormCode(FormCode.ENG_DBD_RESPONSE);
        sharedJurorSetupDbd();
        addData(LetterDataType.DATE_OF_LETTER, 18);
        addData(LetterDataType.DATE_OF_ATTENDANCE, 32);
        addData(LetterDataType.TIME_OF_ATTENDANCE, 8);

    ...
    protected void postProcessTableData(StandardReportRequest request,
        ...
        tableData.getData()
            .forEach(stringObjectLinkedHashMap -> {
                Object trialStart = stringObjectLinkedHashMap.get(DataType.TRIAL_START_DATE.getId());
                Object trialEnd = stringObjectLinkedHashMap.get(DataType.TRIAL_END_DATE.getId());
        ...
        tableData.removeData(DataType.TRIAL_START_DATE, DataType.TRIAL_END_DATE);
    }

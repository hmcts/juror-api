    ...
    private void checkUpdatesToJurorThirdParty(AbstractJurorResponse jurorResponse,
        ...
        if (jurorResponse.getReplyType().getType().equals(ReplyMethod.PAPER.getDescription())) {
            ...
            if (thirdParty != null) {
                ...
                if (hasValueChanged(jurorResponse.getMainPhone(),
                                    thirdParty.getMainPhone(), THIRD_PARTY_MAIN_PHONE, jurorNumber, replyMethod)) {
                    jurorResponse.setMainPhone(thirdParty.getMainPhone());
                }
                if (hasValueChanged(jurorResponse.getOtherPhone(),
                                    thirdParty.getOtherPhone(), THIRD_PARTY_OTHER_PHONE, jurorNumber, replyMethod)) {
                    jurorResponse.setOtherPhone(thirdParty.getOtherPhone());
                }
                if (hasValueChanged(jurorResponse.getEmailAddress(),
                                    thirdParty.getEmailAddress(), THIRD_PARTY_EMAIL_ADDRESS, jurorNumber, replyMethod)) {
